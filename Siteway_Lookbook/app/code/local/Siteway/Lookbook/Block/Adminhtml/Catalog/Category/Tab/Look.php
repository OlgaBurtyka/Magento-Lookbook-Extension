 ...
 */
/**
 * Look tab on category edit form
 *
 * @category    Siteway
 * @package     Siteway_Lookbook
 * @author      Ultimate Module Creator
 */
class Siteway_Lookbook_Block_Adminhtml_Catalog_Category_Tab_Look extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
    ...
    {
        parent::__construct();
        $this->setId('catalog_category_look');
     ...
     *
     * @access protected
     * @return Siteway_Lookbook_Block_Adminhtml_Catalog_Category_Tab_Look
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            array('related' => $collection->getTable('siteway_lookbook/look_category')),
    ...
    public function getSelectedLooks()
    {
        ...
        $selected = Mage::helper('siteway_lookbook/category')->getSelectedLooks(Mage::registry('current_category'));
    ...
    {
        return $this->getUrl(
            'adminhtml/lookbook_look_catalog_category/looksgrid',
            array(
