 ...
 */
/**
 * look - categories relation edit block
 *
 * @category    Siteway
 * @package     Siteway_Lookbook
 * @author      Ultimate Module Creator
 */
class Siteway_Lookbook_Block_Adminhtml_Look_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('siteway_lookbook/look/edit/tab/categories.phtml');
        $this->_withProductCount = false;
    }

    /**
     * Retrieve currently edited look
     *
     * @access public
    ...
    /**
     * Return array with categories IDs which the look is linked to
     *
     * @access public
     * @return array
     * @author Ultimate Module Creator
    ...
    public function getCategoryIds()
    {
        if (is_null($this->_categoryIds)) {
            $categories = $this->getLook()->getSelectedCategories();
            $ids = array();
     ...
     * Returns root node
     *
     * @param Siteway_Lookbook_Model_Category|null $parentNodeCategory
    ...
    /**
     * Returns array with nodes those are selected (contain current look)
     *
     * @return array
     */
